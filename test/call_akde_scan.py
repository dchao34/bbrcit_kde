...
if __name__ == '__main__':
    ...
    parser.add_argument('--outputf_2d', type=str, default='prodadakde2d_scan2d.dat',
                        help='File name to save 2d scan. ')
    parser.add_argument('--outputf_1d', type=str, default='prodadakde2d_scan1d.dat',
                        help='File name to save 1d scan. ')
    parser.add_argument('--a1', type=float, default=0.5,
                        help='Sensitivity in first dimension. ')
    parser.add_argument('--a2', type=float, default=0.5,
                        help='Sensitivity in second dimension. ')
