...
#ifndef __CUDACC__
  fout.open("test_kde20_cpu_direct.csv");
#else 
  fout.open("test_kde20_gpu_direct.csv");
#endif
...
#ifndef __CUDACC__
  fout.open("test_kde20_cpu_tree.csv");
#else 
  fout.open("test_kde20_gpu_tree.csv");
#endif
  write_kde2d_result(fout, queries, 
                     start_x, end_x, steps_x,
                     start_y, end_y, steps_y);
